...
t.test('telemetry - correctly implements interfaces', async t => {
  ...
  telemetry.logger = {
    info(arg) {
      t.strictSame(arg, { ipfs_provider_component: 'uploader-lambda', metrics: { 'custom-count': 1 } })
    }
  }
  ...
  telemetry.logger = {
    info(arg) {
      t.strictSame(arg, { ipfs_provider_component: 'uploader-lambda', metrics: { 'custom-count': 0 } })
    }
  }
